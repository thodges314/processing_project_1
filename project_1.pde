...
void draw() {
  //red square
  int red_square_x = (canvas_width - square_size)/2;
  int red_square_y = 0;
  fill(255,0,0);
  stroke(255,0,0);
  ...
  //blue square
  int blue_square_x = 0;
  int blue_square_y = (canvas_height - square_size)/2;
  fill(0,0,255);
  stroke(0,0,255);
  ...
  int red_square_y_middle = square_size/2;
  int blue_square_x_middle = square_size/2;
